...

{
  ...
  DrawText((AnmManager *)this,vm->sprite->sourceFileIndex,xPos,yPos,textureWidth,textureHeight,
           fontWidth2,fontHeight,textColor_00.color,shadowColor_00.color,pcVar9);
  local_60 = buf;
  do {
    cVar1 = *local_60;
    local_60 = local_60 + 1;
  ...
  textureWidth = __ftol2(vm->sprite->textureWidth);
  yPos = __ftol2((vm->sprite->startPixelInclusive).y);
  DrawText((AnmManager *)this,vm->sprite->sourceFileIndex,local_c,yPos,textureWidth,textureHeight,
           fontWidth,fontHeight,textColor.color,shadowColor.color,pcVar9);
