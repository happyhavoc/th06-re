...

{
  ...
  DrawTextToSprite(this,vm->sprite->sourceFileIndex,spriteSPIXPos,spriteSPIYPos,spriteTextureWidth,
  ...
  spriteTextureWidth = __ftol2(vm->sprite->textureWidth);
  spriteSPIYPos = __ftol2((vm->sprite->startPixelInclusive).y);
  DrawTextToSprite(this,vm->sprite->sourceFileIndex,local_c,spriteSPIYPos,spriteTextureWidth,
