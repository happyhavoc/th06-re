...

{
  ...
  FLOAT_006d4660 = this->vertexBufferContents[0].position.x;
  FLOAT_006d4664 = this->vertexBufferContents[0].position.y;
  FLOAT_006d4668 = this->vertexBufferContents[0].position.z;
  FLOAT_006d4678 = this->vertexBufferContents[0].textureUV.y;
  FLOAT_006d467c = this->vertexBufferContents[1].position.x;
  FLOAT_006d4680 = this->vertexBufferContents[1].position.y;
  FLOAT_006d4690 = this->vertexBufferContents[1].textureUV.x;
  FLOAT_006d4694 = this->vertexBufferContents[1].textureUV.y;
  FLOAT_006d4698 = this->vertexBufferContents[2].position.x;
  UINT_006d46a8 = this->vertexBufferContents[2].diffuseColor;
  FLOAT_006d46ac = this->vertexBufferContents[2].textureUV.x;
  FLOAT_006d46b0 = this->vertexBufferContents[2].textureUV.y;
  UINT_006d4670 = this->vertexBufferContents[0].diffuseColor;
  FLOAT_006d4674 = this->vertexBufferContents[0].textureUV.x;
  FLOAT_006d4688 = this->vertexBufferContents[1].position.z;
  UINT_006d468c = this->vertexBufferContents[1].diffuseColor;
  FLOAT_006d46a0 = this->vertexBufferContents[2].position.y;
  FLOAT_006d46a4 = this->vertexBufferContents[2].position.z;
  FLOAT_006d46b8 = this->vertexBufferContents[3].position.x;
  FLOAT_006d46bc = this->vertexBufferContents[3].position.y;
