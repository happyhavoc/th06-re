  ...
  for (local_14 = 0; local_14 < 0x40; local_14 = local_14 + 1) {
    if (local_2c->in_use != 0) {
      if (local_2c->state < 2) {
        ...
        if (param_2 != 0) {
          ItemManager::SpawnItem((ItemManager *)&g_ItemManager,&local_2c->pos,ITEM_POINT_BULLET,1);
          ...
          for (; local_34 < local_2c->end_offset; local_34 = local_34 + 32.0) {
            ...
            local_28.z = 0.0;
            ItemManager::SpawnItem((ItemManager *)&g_ItemManager,&local_28,ITEM_POINT_BULLET,1);
          }
        }
      }
