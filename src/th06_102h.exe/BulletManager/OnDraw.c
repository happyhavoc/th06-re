...
ChainCallbackResult th06::BulletManager::OnDraw(BulletManager *arg)

{
  ...
  for (local_8 = 0; local_8 < 0x40; local_8 = local_8 + 1) {
    if (local_10->in_use != 0) {
      ...
      local_10->color = -1;
      AnmManager::Draw3((AnmManager *)g_AnmManager,&local_10->vm0);
      if ((local_10->start_offset < 16.0 != NAN(local_10->start_offset)) ||
        ...
        AnmManager::Draw3((AnmManager *)g_AnmManager,&local_10->vm1);
      }
    }
    local_10 = local_10 + 1;
  }
