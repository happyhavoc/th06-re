      ...
      case 5:
        ...
        if (iVar3 != 0) {
          ...
          for (iVar3 = 0x171; iVar3 != 0; iVar3 = iVar3 + -1) {
            (pBVar4->sprites).spriteBullet.rotation.x = 0.0;
            pBVar4 = (Bullet *)&(pBVar4->sprites).spriteBullet.rotation.y;
          }
            ...
            if ((bulletsPtr->ex_flags & 0x100) == 0) {
              if ((bulletsPtr->ex_flags & 0x80) == 0) {
                  ...
                  if (((bulletsPtr->ex_flags & 0x800) != 0) &&
                     (iVar3 = GameManager::IsInBounds
                                        (&g_GameManager,(bulletsPtr->pos).x,(bulletsPtr->pos).y,
                                         ((bulletsPtr->sprites).spriteBullet.sprite)->widthPx,
                                         ((bulletsPtr->sprites).spriteBullet.sprite)->heightPx),
                     iVar3 == 0)) {
                ...
                if ((bulletsPtr->timer).current <
                  ...
                  velZ = Player::AngleToPlayer((Player *)&g_Player,&bulletsPtr->pos);
...
LAB_00415b6c:
          if (bulletsPtr->is_grazed == 0) {
            local_8 = Player::CheckGraze((Player *)&g_Player,&bulletsPtr->pos,
                                         &(bulletsPtr->sprites).grazeSize);
            if (local_8 == 1) {
              bulletsPtr->is_grazed = 1;
LAB_00415be8:
              local_8 = Player::CalcKillBoxCollision
                                  ((Player *)&g_Player,&bulletsPtr->pos,
                                   &(bulletsPtr->sprites).grazeSize);
        ...
        if (bVar1 == 0) {
          ...
          if (curLaser->graze_delay <= (curLaser->timer).current) {
            Player::CalcLaserHitbox
                      ((Player *)&g_Player,&local_38,&local_20,&curLaser->pos,curLaser->angle,
