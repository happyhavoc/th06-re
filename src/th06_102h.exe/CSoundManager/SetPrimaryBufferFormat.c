...
CSoundManager::SetPrimaryBufferFormat
          (CSoundManager *this,short channels,int samples_per_sec,ushort bits_per_sample)

{
  ...
  if (this->m_pDS != (LPDIRECTSOUND8)0x0) {
    ...
    HVar1 = (*this->m_pDS->lpVtbl->CreateSoundBuffer)(this->m_pDS,&soundbuf,&local_8,(LPUNKNOWN)0x0)
    ;
    if (-1 < HVar1) {
