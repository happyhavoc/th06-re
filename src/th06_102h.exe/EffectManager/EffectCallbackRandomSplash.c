...
int th06::EffectManager::EffectCallbackRandomSplash(Effect *param_1)

{
  ...
  if (((param_1->timer).current == 0) && ((param_1->timer).current != (param_1->timer).previous)) {
    ...
    (param_1->field2_0x11c).x = (fVar2 * 256.0 - 128.0) / 12.0;
    fVar2 = Rng::GetRandomF32ZeroToOne(&g_Rng);
    (param_1->field2_0x11c).y = (fVar2 * 256.0 - 128.0) / 12.0;
    (param_1->field2_0x11c).z = 0.0;
    fVar2 = (param_1->field2_0x11c).z;
    fVar1 = (param_1->field2_0x11c).y;
    (param_1->field3_0x128).x = -(param_1->field2_0x11c).x * 0.05263158;
    (param_1->field3_0x128).y = -fVar1 * 0.05263158;
    (param_1->field3_0x128).z = -fVar2 * 0.05263158;
  }
