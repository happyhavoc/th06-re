...
int th06::EffectManager::EffectUpdateCallback1(Effect *param_1)

{
  ...
  if (((param_1->timer).current == 0) && ((param_1->timer).current != (param_1->timer).previous)) {
    ...
    param_1->field2_0x11c = (fVar2 * 256.0 - 128.0) / 12.0;
    fVar2 = Rng::GetRandomF32ZeroToOne(&g_Rng);
    param_1->field3_0x120 = (fVar2 * 256.0 - 128.0) / 12.0;
    param_1->field4_0x124 = 0.0;
    param_1->field5_0x128 = -param_1->field2_0x11c * 0.05263158;
    param_1->field6_0x12c = -param_1->field3_0x120 * 0.05263158;
    param_1->field7_0x130 = -param_1->field4_0x124 * 0.05263158;
  }
