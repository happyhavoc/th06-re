...
undefined4 EffectManager::FUN_0040e360(int param_1)

{
  ...
  {
    fVar2 = FUN_0041e820(&DAT_0069d8f8);
  ...
  fVar2 = g_GameContext.field81_0x1a8 * *(float *)(param_1 + 0x124);
  fVar1 = g_GameContext.field81_0x1a8 * *(float *)(param_1 + 0x120);
  *(float *)(param_1 + 0x110) =
       g_GameContext.field81_0x1a8 * *(float *)(param_1 + 0x11c) + *(float *)(param_1 + 0x110);
  *(float *)(param_1 + 0x114) = fVar1 + *(float *)(param_1 + 0x114);
  *(float *)(param_1 + 0x118) = fVar2 + *(float *)(param_1 + 0x118);
  fVar2 = g_GameContext.field81_0x1a8 * *(float *)(param_1 + 0x130);
  fVar1 = g_GameContext.field81_0x1a8 * *(float *)(param_1 + 300);
  *(float *)(param_1 + 0x11c) =
       g_GameContext.field81_0x1a8 * *(float *)(param_1 + 0x128) + *(float *)(param_1 + 0x11c);
