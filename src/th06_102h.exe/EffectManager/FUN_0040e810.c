...

{
  ...
  fVar1 = g_Supervisor.field81_0x1a8 * *(float *)(param_1 + 0x124);
  fVar2 = g_Supervisor.field81_0x1a8 * *(float *)(param_1 + 0x120);
  *(float *)(param_1 + 0x110) =
  ...
  *(float *)(param_1 + 0x118) = fVar1 + *(float *)(param_1 + 0x118);
  fVar1 = g_Supervisor.field81_0x1a8 * *(float *)(param_1 + 0x130);
  fVar2 = g_Supervisor.field81_0x1a8 * *(float *)(param_1 + 300);
  *(float *)(param_1 + 0x11c) =
