...
void Enemy::MathDiv(Enemy *param_1,undefined4 param_2,float *param_3,float *param_4)

{
  ...
  if (local_14 == ECL_VALUE_TYPE_INT) {
    local_10 = (float *)GetVar(param_1,(int *)param_3,(EclValueType *)0x0);
    piVar1 = GetVar(param_1,(int *)param_4,(EclValueType *)0x0);
