...

{
  ...
  if (this->pbg3File[pbg3FileIdx] != (Pbg3File *)0x0) {
...
LAB_00424435:
  ...
  DebugPrint("%s open ...\n",filename);
  iVar2 = Pbg3File::Load(this->pbg3File[pbg3FileIdx],(char *)filename);
  if (iVar2 == 0) {
    ...
    this->pbg3File[pbg3FileIdx] = (Pbg3File *)0x0;
    this->pbg3File[pbg3FileIdx] = (Pbg3File *)0x0;
  }
  else {
    pbStack_c8 = filename;
    ...
    uStack_14 = Pbg3File::FindEntry(this->pbg3File[pbg3FileIdx],acStack_98);
    if ((int)uStack_14 < 0) {
