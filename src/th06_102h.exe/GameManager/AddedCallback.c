...

{
  ...
  if ((param_1->field42_0x1823 != 0) && (param_1->current_stage != 1)) {
  ...
  if (g_GameManager.field10_0x1c == 1) {
    ...
    while (UINT_ARRAY_004764b0[(char)param_1->field35_0x181c] <= (uint)param_1->field0_0x0) {
      param_1->field35_0x181c = param_1->field35_0x181c + 1;
    }
  ...
  g_Rng.unk4 = 0;
  param_1->field53_0x1a2c = g_Rng.seed;
