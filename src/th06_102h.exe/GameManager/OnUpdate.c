...

{
  ...
  if (((this->is_in_game_menu == 1) || (this->is_in_game_menu == 2)) ||
    ...
    if (this->field0_0x0 != this->score) {
      ...
      if ((-1 < (char)this->field38_0x181c) &&
         (UINT_ARRAY_004764b0[(char)this->field38_0x181c] <= (uint)this->field0_0x0)) {
        ...
        this->field38_0x181c = this->field38_0x181c + 1;
