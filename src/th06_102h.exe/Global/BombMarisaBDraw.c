...
void BombMarisaBDraw(void **param_1)

{
  ...
  FUN_00406020();
  local_8 = (AnmVm *)(param_1 + 0x1db9);
  for (local_c = 0; local_c < 4; local_c = local_c + 1) {
    fVar1 = (((float)local_c * 0.6283185) / 3.0 - 3.141593) + 1.256637;
    (local_8->pos).x = (float)param_1[0x110];
    (local_8->pos).y = (float)param_1[0x111];
    (local_8->pos).z = (float)param_1[0x112];
