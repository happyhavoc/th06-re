...

{
  ...
  iVar1 = Chain::AddToCalcChain(&CHAIN,&ChainElem_00487aac,1);
  if (iVar1 == 0) {
    ...
    Chain::AddToDrawChain(&CHAIN,&ChainElem_0047b8e0,0xf);
    ...
    Chain::AddToDrawChain(&CHAIN,&ChainElem_00487acc,10);
    uVar2 = 0;
  }
  else {
    uVar2 = 0xffffffff;
