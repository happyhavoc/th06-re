...

{
  ...
  case 0:
    if (in_ECX[1] == 0) {
      ...
      if (DAT_006c7115 != '\0') {
        VERY_BIG_STRUCT->field19959_0x21118 = 3;
        pVVar1->field19960_0x2111c = 0x20;
        pVVar1->field19961_0x21120 = 0x10;
        pVVar1->field19962_0x21124 = 0x180;
        pVVar1->field19963_0x21128 = 0x1c0;
