...
LAB_0040954d:
    ...
    if ((*(byte *)((int)&param_1[0xd].flags + 2) >> 2 & 1) == 0) {
      ...
      for (iVar20 = 0x13; iVar20 != 0; iVar20 = iVar20 + -1) {
        *pfVar18 = (pAVar17->rotation).x;
        pAVar17 = (AnmVm *)&(pAVar17->rotation).y;
        pfVar18 = pfVar18 + 1;
      }
    }
  ...
  if (param_1[9].angleVel.x != *local_20) {
    ...
    if (0 < (int)param_1[0xc].scaleInterpFinalX) {
      ...
      if (-1 < param_1[0xd].pendingInterrupt) {
        ...
        if (*(char *)((int)&param_1[0xd].flags + 3) != cVar5) {
          if (cVar5 == '\0') {
            if (*(char *)((int)&param_1[0xd].flags + 3) == -1) {
              uVar7 = param_1[0xd].alphaInterpEndTime;
              local_268 = uVar7 + 0x100;
              param_1->anmFileIndex = local_268;
              AnmManager::SetAndExecuteScript(pAVar9,param_1,pAVar9->scripts[(short)uVar7 + 0x100]);
            }
            else if (*(char *)((int)&param_1[0xd].flags + 3) == '\x01') {
              uVar7 = param_1[0xd].scaleInterpEndTime;
              local_270 = uVar7 + 0x100;
              param_1->anmFileIndex = local_270;
              AnmManager::SetAndExecuteScript(pAVar9,param_1,pAVar9->scripts[(short)uVar7 + 0x100]);
            }
            else {
              uVar7 = param_1[0xd].autoRotate;
              local_278 = uVar7 + 0x100;
              param_1->anmFileIndex = local_278;
              AnmManager::SetAndExecuteScript(pAVar9,param_1,pAVar9->scripts[(short)uVar7 + 0x100]);
            }
          }
          else if (cVar5 == '\x01') {
            sVar6 = param_1[0xd].pendingInterrupt;
            local_280 = sVar6 + 0x100;
            param_1->anmFileIndex = local_280;
            AnmManager::SetAndExecuteScript(pAVar9,param_1,pAVar9->scripts[sVar6 + 0x100]);
          }
          else if (cVar5 == '\x02') {
            uVar7 = param_1[0xd].posInterpEndTime;
            local_288 = uVar7 + 0x100;
            param_1->anmFileIndex = local_288;
            AnmManager::SetAndExecuteScript(pAVar9,param_1,pAVar9->scripts[(short)uVar7 + 0x100]);
          }
          *(char *)((int)&param_1[0xd].flags + 3) = cVar5;
        }
      }
...
switchD_00407544_caseD_2:
  ...
  case 0x4b:
    ...
    *(undefined2 *)(local_58 + 0x11) = *(undefined2 *)piVar12;
    iVar20 = ((int)*(short *)((int)&param_1[0xc].scaleX + 2) - (int)*(short *)&param_1[0xc].scaleX)
             * _DAT_0069d710;
    *(short *)(local_58 + 0x11) =
    ...
    *(short *)((int)local_58 + 0x46) =
    ...
    if ((NAN(local_58[6]) == (local_58[6] == 0.0)) &&
       ...
       local_58[6] = ((param_1[0xc].scaleY - fVar25) * (float)_DAT_0069d710) / 32.0 + fVar25 +
    ...
    local_58[7] = *pfVar18;
    fVar25 = param_1[0xc].angleVel.z;
    local_58[7] = (((param_1[0xc].scaleY - fVar25) * (float)_DAT_0069d710) / 32.0 + fVar25) / 2.0 +
                  local_58[7];
  ...
  case 0x56:
    ...
    *(float *)((int)(local_60 + 6) + 4) = local_64[0xc];
    ...
    iVar20 = FUN_00414670();
    (&param_1[0xc].posInterpTime.current)[(int)param_1[0xd].matrix.m[2][3]] = iVar20;
    break;
  case 0x57:
    pfVar18 = (float *)FUN_0040afb0((int)param_1,(int *)(local_20 + 3),(undefined4 *)0x0);
    param_1[0xd].matrix.m[2][3] = *pfVar18;
    break;
  case 0x58:
  ...
  case 0x5a:
    if ((&param_1[0xc].posInterpTime.current)[(int)local_20[3]] != 0) {
      ...
      *(float *)(iVar20 + 0x224) = (float)pAVar3 + fVar4;
      *(float *)(iVar20 + 0x228) = fVar25 + fVar24;
    }
    break;
  case 0x5b:
    if (((&param_1[0xc].posInterpTime.current)[(int)local_20[3]] == 0) ||
  ...
  case 0x66:
    local_6c = local_20 + 3;
    pAVar17 = FUN_0040ef50((int *)&AnmRelatedHugeStruct_00487fe0,0xd,
    ...
    *(float *)(DVar8 + 0x140) = local_6c[1];
    *(float *)(DVar8 + 0x144) = local_6c[2];
    *(float *)(DVar8 + 0x148) = local_6c[3];
