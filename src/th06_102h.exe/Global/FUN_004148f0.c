...

{
  ...
  ChainElem_0069bc10.added_callback = FUN_00416d60;
  ChainElem_0069bc10.deleted_callback = FUN_00417270;
  ...
  if (iVar1 == 0) {
    ...
    ChainElem_005a5fd8.added_callback = 0;
    ChainElem_005a5fd8.deleted_callback = 0;
