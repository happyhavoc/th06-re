...

{
  ...
  *(undefined2 *)(iVar2 + 0x1e78) = 0x4a1;
  FUN_00432430((Unknown *)(iVar2 + 0x1dc4),*(int *)&pVVar3->field_0x1dbb8);
  FUN_004323a0(g_VeryBigStruct,(Unknown *)(*(int *)(param_1_00 + 4) + 0x1dc4),(short)param_2);
  pVVar3 = g_VeryBigStruct;
  iVar2 = *(int *)(param_1_00 + 4);
  *(undefined2 *)(iVar2 + 0x2098) = 0x706;
  FUN_00432430((Unknown *)(iVar2 + 0x1fe4),*(int *)&pVVar3->field_0x1e54c);
  FUN_00434b60(g_VeryBigStruct,*(int *)(param_1_00 + 4) + 0x1fe4,0xf0f0ff,0,param_3);
  local_1c = param_3;
  do {
    cVar1 = *local_1c;
    local_1c = local_1c + 1;
