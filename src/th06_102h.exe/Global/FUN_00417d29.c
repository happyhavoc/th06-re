...

{
  ...
  if (g_GameContext.unkInput2 == 3) {
    ...
    *(undefined2 *)(in_ECX[1] + 0x24ae) = 1;
    ...
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0xd,"data/front.anm",0x600);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0xe,"data/loading.anm",0x619);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    *(undefined2 *)(in_ECX[1] + 0x24d4) = 0xffff;
    if (DAT_0069d4bd == '\0') {
      iVar3 = AnmManager::LoadAnim(g_AnmManager,0xf,"data/face00a.anm",0x4a0);
      if (iVar3 != 0) {
        return 0xffffffff;
      }
      iVar3 = AnmManager::LoadAnim(g_AnmManager,0x10,"data/face00b.anm",0x4a2);
      if (iVar3 != 0) {
        return 0xffffffff;
      }
      iVar3 = AnmManager::LoadAnim(g_AnmManager,0x11,"data/face00c.anm",0x4a4);
      if (iVar3 != 0) {
        return 0xffffffff;
      }
    }
    else if (DAT_0069d4bd == '\x01') {
      iVar3 = AnmManager::LoadAnim(g_AnmManager,0xf,"data/face01a.anm",0x4a0);
      if (iVar3 != 0) {
        return 0xffffffff;
      }
      iVar3 = AnmManager::LoadAnim(g_AnmManager,0x10,"data/face01b.anm",0x4a2);
      if (iVar3 != 0) {
        return 0xffffffff;
      }
      iVar3 = AnmManager::LoadAnim(g_AnmManager,0x11,"data/face01c.anm",0x4a4);
      if (iVar3 != 0) {
        return 0xffffffff;
      }
    }
  ...
  if (DAT_0069d6d4 == 1) {
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x12,"data/face03a.anm",0x4a8);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x13,"data/face03b.anm",0x4aa);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    ...
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x12,"data/face05a.anm",0x4a8);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    ...
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x12,"data/face06a.anm",0x4a8);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x13,"data/face06b.anm",0x4aa);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    ...
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x12,"data/face08a.anm",0x4a8);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x13,"data/face08b.anm",0x4aa);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    ...
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x12,"data/face09a.anm",0x4a8);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x13,"data/face09b.anm",0x4aa);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    ...
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x12,"data/face09b.anm",0x4a8);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x13,"data/face10a.anm",0x4aa);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x14,"data/face10b.anm",0x4ab);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    ...
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x13,"data/face12a.anm",0x4aa);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
    iVar3 = AnmManager::LoadAnim(g_AnmManager,0x14,"data/face12b.anm",0x4ab);
    if (iVar3 != 0) {
      return 0xffffffff;
    }
