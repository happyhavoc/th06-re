  ...
  if (param_1 < **(int **)(in_ECX + 0x2534)) {
    ...
    *(undefined *)(in_ECX + 0x2bd8) = 1;
    if ((DAT_0069d6d4 == 6) && ((param_1 == 0 || (param_1 == 10)))) {
      FUN_00431dc0((int)VERY_BIG_STRUCT,0xb,"data/eff06.anm",0x2b3);
    }
    else if ((DAT_0069d6d4 == 7) && ((param_1 == 0 || (param_1 == 10)))) {
      FUN_00431dc0((int)VERY_BIG_STRUCT,0xb,"data/eff07.anm",0x2b3);
      FUN_00431dc0((int)VERY_BIG_STRUCT,0x12,"data/face12c.anm",0x4a8);
    }
  }
  return;
}
