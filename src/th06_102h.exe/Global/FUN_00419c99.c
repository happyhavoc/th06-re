...

{
  ...
  if ((*(int *)(param_1[1] + 0x253c) < 0) &&
    ...
    FUN_00432ad0(VERY_BIG_STRUCT,local_14);
    uVar1 = param_1[1];
  ...
  local_14 = param_1[1] + 0x660;
  if ((((uint)g_GameContext.cfg.render_opts >> DISPLAY_MINIMUM_GRAPHICS & 1) == 0) &&
     (((*(int *)(param_1[1] + 0x71c) != 0 || (g_GameContext._408_4_ != 0)) ||
    ...
    FUN_00432ad0(VERY_BIG_STRUCT,param_1[1] + 0x990);
    FUN_00432ad0(VERY_BIG_STRUCT,param_1[1] + 0xaa0);
    FUN_00432ad0(VERY_BIG_STRUCT,param_1[1] + 0xbb0);
    FUN_00432ad0(VERY_BIG_STRUCT,param_1[1] + 0xcc0);
    FUN_00432ad0(VERY_BIG_STRUCT,param_1[1] + 0xdd0);
    FUN_00432ad0(VERY_BIG_STRUCT,param_1[1] + 0xee0);
    FUN_00432ad0(VERY_BIG_STRUCT,param_1[1] + 0xff0);
