...

{
  ...
  if ((*(uint *)(*(int *)(param_1 + 4) + 0x1e44) & 1) != 0) {
    FUN_00432ad0(VERY_BIG_STRUCT,*(int *)(param_1 + 4) + 0x1dc4);
  }
  if ((*(uint *)(*(int *)(param_1 + 4) + 0x1f54) & 1) != 0) {
    FUN_00432ad0(VERY_BIG_STRUCT,*(int *)(param_1 + 4) + 0x1ed4);
  }
  if ((*(uint *)(*(int *)(param_1 + 4) + 0x2064) & 1) != 0) {
    ...
    *(float *)(*(int *)(param_1 + 4) + 0x2220) = *(float *)(param_1 + 8) / 14.0;
    FUN_00432ad0(VERY_BIG_STRUCT,*(int *)(param_1 + 4) + 0x2204);
    FUN_00432ad0(VERY_BIG_STRUCT,*(int *)(param_1 + 4) + 0x1fe4);
  }
  if ((*(uint *)(*(int *)(param_1 + 4) + 0x2174) & 1) != 0) {
    ...
    *(float *)(*(int *)(param_1 + 4) + 0x2330) = *(float *)(param_1 + 0xc) / 14.0;
    FUN_00432ad0(VERY_BIG_STRUCT,*(int *)(param_1 + 4) + 0x2314);
    FUN_00432ad0(VERY_BIG_STRUCT,*(int *)(param_1 + 4) + 0x20f4);
  }
  if (-1 < *(short *)(*(int *)(param_1 + 4) + 0x24d4)) {
    ...
    FUN_00432ad0(VERY_BIG_STRUCT,*(int *)(param_1 + 4) + 0x2424);
  }
  return;
}
