...

{
  ...
  if (DAT_006c6e47 == '\x02') {
    ...
    iVar2 = SoundPlayer::FUN_00430e10((SoundPlayer *)&DAT_006d3f50,local_10c);
    if (iVar2 < 0) {
      SoundPlayer::playBGM((SoundPlayer *)&DAT_006d3f50,0);
    }
    else {
      SoundPlayer::playBGM((SoundPlayer *)&DAT_006d3f50,1);
    }
  }
