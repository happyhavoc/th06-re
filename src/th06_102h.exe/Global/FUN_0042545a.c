...

{
  ...
  FUN_00432ad0(g_VeryBigStruct,param_1 + 0x24);
  for (local_8 = *(int *)(param_1 + 0x18); local_8 < *(int *)(param_1 + 0x18) + 10;
    ...
    *(undefined4 *)(param_1 + 0x1cc + local_8 * 0x110) = 0;
    FUN_00432ad0(g_VeryBigStruct,param_1 + 0x134 + local_8 * 0x110);
  ...
  for (local_8 = 0; local_8 < 0x10; local_8 = local_8 + 1) {
    FUN_00432ad0(g_VeryBigStruct,param_1 + 0x2334 + local_8 * 0x110);
  }
  _DAT_00481b24 = 0xffffffff;
  return 1;
}
