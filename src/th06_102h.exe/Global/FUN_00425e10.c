...

{
  ...
  FUN_00424127((AnmTimer *)(param_1 + 0x9e8));
  local_5c = 0x50;
  local_64 = (AnmVm *)(param_1 + 0xa28);
  while (local_5c = local_5c + -1, -1 < local_5c) {
    FUN_00403720(local_64);
    FUN_00424127(&local_64[1].currentTimeInScript);
    local_64 = (AnmVm *)((int)&local_64[1].matrix.field0_0x0 + 0xc);
  }
  FUN_00424127((AnmTimer *)(param_1 + 0x75a8));
  FUN_00424127((AnmTimer *)(param_1 + 0x75b4));
  FUN_00426000();
  return param_1;
}
