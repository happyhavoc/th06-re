...

{
  ...
  iVar2 = Chain::AddToCalcChain((Chain *)&DAT_0069d918,DAT_006d3f0c,7);
  if (iVar2 == 0) {
    Chain::AddToDrawChain((Chain *)&DAT_0069d918,DAT_006d3f10,5);
    Chain::AddToDrawChain((Chain *)&DAT_0069d918,DAT_006d3f14,7);
    uVar1 = 0;
  }
  else {
    uVar1 = 0xffffffff;
