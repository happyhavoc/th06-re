...

{
  ...
  PTR_006d3f0c = ChainElem::Allocate(FUN_004288c0);
  PTR_006d3f10 = ChainElem::Allocate(FUN_00429930);
  PTR_006d3f14 = ChainElem::Allocate(FUN_00429b90);
  PTR_006d3f0c->arg = &DAT_006ca628;
  PTR_006d3f10->arg = &DAT_006ca628;
  PTR_006d3f14->arg = &DAT_006ca628;
  PTR_006d3f0c->addedCallback = FUN_00429c50;
  PTR_006d3f0c->deletedCallback = FUN_0042a0b0;
