...

{
  ...
  if (((float)g_GameContext._428_4_ < 0.99 == NAN((float)g_GameContext._428_4_)) || (param_1 != 0))
  {
    ...
    if (DAT_006d3f18 == (void *)0x0) {
      ...
      *(undefined4 *)((int)local_14 + 0xc) = param_2;
      if (param_1 == 0) {
        pCVar1 = AllocateChainElem(&CHAIN,FUN_0042a470);
        ...
        *(undefined4 *)((int)local_14 + 0x70) = 0;
        ...
        pCVar1 = AllocateChainElem(&CHAIN,FUN_0042a570);
        *(ChainElem **)((int)local_14 + 0x68) = pCVar1;
