...

{
  ...
  *param_1 = 0;
  if (param_1[1] == 0) {
    ...
    *(undefined *)(param_1[1] + 7) = (undefined)CUR_RANK;
    *(undefined4 *)(param_1[1] + 0x19) = 0x4e204f4e;
    ...
    puVar1 = *(undefined4 **)(param_1[1] + 0x2c + CUR_STAGE * 4);
  ...
  *(void **)(param_1[1] + 0x30 + CUR_STAGE * 4) = pvVar3;
  iVar2 = *(int *)(param_1[1] + 0x30 + CUR_STAGE * 4);
  *(undefined *)(iVar2 + 10) = BOMB_COUNT;
  *(undefined *)(iVar2 + 9) = LIFE_COUNT;
  *(undefined *)(iVar2 + 8) = DAT_0069d4b0;
