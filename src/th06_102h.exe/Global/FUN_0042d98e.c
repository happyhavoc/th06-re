    ...
    if (iVar1 == 8) {
        ...
        *(undefined4 *)(param_1 + 0x28) = *(undefined4 *)(param_1 + 0x10);
        for (local_8 = *(int *)(param_1 + 0x28) * 10;
          ...
          if (*(short *)(&DAT_0069bd0c + local_8 * 0x40) == 0) {
            FUN_00434b60(VERY_BIG_STRUCT,param_1 + 0x28a0 + (local_8 % 10) * 0x110,0xffffff,0,
                         &DAT_0046bcdc);
          }
          else {
            FUN_00434b60(VERY_BIG_STRUCT,param_1 + 0x28a0 + (local_8 % 10) * 0x110,0xffffff,0,
        ...
        if (*(int *)(param_1 + 4) == 0) {
          ...
          for (local_8 = 0; local_8 < 0x26; local_8 = local_8 + 1) {
            ...
            *(uint *)(local_c + 0x80) = *(uint *)(local_c + 0x80) | 8;
            if ((g_GameContext.cfg.field34_0x34 & 1U) == 0) {
              ...
              *(undefined4 *)(local_c + 0x7c) = *(undefined4 *)(local_c + 0x7c);
            }
            local_c = local_c + 0x110;
          }
          ...
          for (local_8 = 0; local_8 < 7; local_8 = local_8 + 1) {
            if (local_8 == *(int *)(param_1 + 0x10)) {
              ...
              *(undefined4 *)(local_c + 0xe4) = 0xc0800000;
              *(undefined4 *)(local_c + 0xe8) = 0xc0800000;
              *(undefined4 *)(local_c + 0xec) = 0;
              ...
              if ((g_GameContext.cfg.field34_0x34 & 1U) == 0) {
                ...
                *(undefined4 *)(local_c + 0x7c) = 0xb0ffffff;
              }
        ...
        if (iVar1 == 2) {
          ...
          if ((*(int *)(param_1 + 0x24) != *(int *)(param_1 + 0x10)) &&
            ...
            *(undefined4 *)(param_1 + 0x24) = *(undefined4 *)(param_1 + 0x10);
            FUN_00434e20(VERY_BIG_STRUCT,param_1 + 0x28a0,0xffffff,0,
                         (&PTR_DAT_004784d8)[*(int *)(param_1 + 0x24) * 2]);
            FUN_00434e20(VERY_BIG_STRUCT,param_1 + 0x29b0,0xffffff,0,
      ...
      if (((DAT_0069d904 & 0x1001) != 0) && ((DAT_0069d904 & 0x1001) != (DAT_0069d908 & 0x1001))) {
        ...
        if (-1 < iVar1) {
          if (iVar1 < 5) {
            for (local_8 = 0; local_8 < 0x26; local_8 = local_8 + 1) {
              *(short *)(local_c + 0x8a) = (short)*(undefined4 *)(param_1 + 0x10) + 3;
              local_c = local_c + 0x110;
            }
