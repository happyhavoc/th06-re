...
void FUN_00434e20(undefined4 param_1,int param_2,undefined4 param_3,undefined4 param_4,char *param_5
                 )

{
  ...
  FUN_00434af0(**(undefined4 **)(param_2 + 0xc0),lVar6,lVar5,lVar4,lVar3,uVar7,uVar2,uVar8,uVar9,
               puVar10);
  local_60 = local_54;
  do {
    cVar1 = *local_60;
  ...
  local_c = __ftol2((double)((*(float *)(*(int *)(param_2 + 0xc0) + 0x18) / 2.0 +
                             *(float *)(*(int *)(param_2 + 0xc0) + 4)) -
                            ((float)(ulonglong)(uint)((int)local_60 - (int)(local_54 + 1)) *
                            (float)(local_5c + 1)) / 4.0));
  pcVar11 = local_54;
  uVar7 = (uint)*(byte *)(param_2 + 0x10d);
  lVar3 = __ftol2((double)*(float *)(*(int *)(param_2 + 0xc0) + 0x14));
  lVar4 = __ftol2((double)*(float *)(*(int *)(param_2 + 0xc0) + 0x18));
  lVar5 = __ftol2((double)*(float *)(*(int *)(param_2 + 0xc0) + 8));
  FUN_00434af0(**(undefined4 **)(param_2 + 0xc0),local_c,lVar5,lVar4,lVar3,local_5c,uVar7,param_3,
               param_4,pcVar11);
