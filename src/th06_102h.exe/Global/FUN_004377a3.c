...

{
  if (param_2 == param_3) {
    if ((DAT_006c6e60 >> 8 & 1 | DAT_006c6e60 & 1) == 0) {
      ...
      AnmManager::FUN_004323a0(DAT_006d4588,param_1,param_1->anotherSpriteNumber + param_6);
    ...
    if ((DAT_006c6e60 >> 8 & 1 | DAT_006c6e60 & 1) == 0) {
      ...
      AnmManager::FUN_004323a0(DAT_006d4588,param_1,(int)param_1->anotherSpriteNumber);
