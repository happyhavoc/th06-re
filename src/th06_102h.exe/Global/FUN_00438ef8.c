  ...
  if (param_4 == param_5) {
    if (((uint)g_GameContext.cfg.render_opts >> 8 & 1 | g_GameContext.cfg.render_opts & 1U) == 0) {
      *(undefined4 *)(param_2 + 0x7c) = 0x800000ff;
      ...
      FUN_004323a0(g_VeryBigStruct,(Unknown *)param_2,*(short *)(param_2 + 0xb2) + 0x7a);
    }
    else {
      FUN_004323a0(g_VeryBigStruct,(Unknown *)param_2,*(short *)(param_2 + 0xb2) + 0x73);
    }
    ...
    *(undefined4 *)(param_2 + 0xec) = 0;
    ...
    if (((uint)g_GameContext.cfg.render_opts >> 8 & 1 | g_GameContext.cfg.render_opts & 1U) == 0) {
      *(undefined4 *)(param_2 + 0x7c) = 0x80202050;
      ...
      FUN_004323a0(g_VeryBigStruct,(Unknown *)param_2,*(short *)(param_2 + 0xb2));
    }
