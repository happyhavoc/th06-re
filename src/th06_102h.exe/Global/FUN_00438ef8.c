  ...
  if (param_4 == param_5) {
    if ((g_GameContext.cfg.opts >> 8 & 1 | g_GameContext.cfg.opts & 1) == 0) {
      *(undefined4 *)(param_2 + 0x7c) = 0x800000ff;
      ...
      AnmManager::SetActiveSprite(g_AnmManager,(AnmVm *)param_2,*(short *)(param_2 + 0xb2) + 0x7a);
    }
    else {
      AnmManager::SetActiveSprite(g_AnmManager,(AnmVm *)param_2,*(short *)(param_2 + 0xb2) + 0x73);
    }
    ...
    *(undefined4 *)(param_2 + 0xec) = 0;
    ...
    if ((g_GameContext.cfg.opts >> 8 & 1 | g_GameContext.cfg.opts & 1) == 0) {
      *(undefined4 *)(param_2 + 0x7c) = 0x80202050;
      ...
      AnmManager::SetActiveSprite(g_AnmManager,(AnmVm *)param_2,(int)*(short *)(param_2 + 0xb2));
    }
