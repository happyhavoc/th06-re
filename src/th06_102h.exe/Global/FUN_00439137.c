...

{
  ...
  for (local_8 = 0; local_8 < 2; local_8 = local_8 + 1) {
    FUN_00438ef8(param_1,local_c,4,local_8,(uint)g_GameContext.cfg.playSound);
    local_c = local_c + 0x110;
  }
  local_c = param_1 + 0x51d0;
  for (local_8 = 0; local_8 < 3; local_8 = local_8 + 1) {
    FUN_00438ef8(param_1,local_c,3,local_8,(uint)g_GameContext.cfg.soundMode);
    local_c = local_c + 0x110;
  }
  ...
  if (0x1f < *(int *)(param_1 + 0x81f4)) {
    if ((((BUTTONS_PRESSED_CURFRAME & 0x40) != 0) &&
      ...
      if (iVar1 == 0) {
        ...
        FUN_004311e0(0xc,0);
        FUN_00424d38();
        if (g_GameContext.cfg.soundMode == 0) {
          g_GameContext.cfg.soundMode = 3;
        }
        g_GameContext.cfg.soundMode = g_GameContext.cfg.soundMode - 1;
        FUN_00424b2f("bgm/th06_01.mid");
        FUN_00424b5d("bgm/th06_01.mid");
      }
      else if (iVar1 == 4) {
        FUN_004311e0(0xc,0);
        if (g_GameContext.cfg.playSound == 0) {
          g_GameContext.cfg.playSound = 2;
        }
        g_GameContext.cfg.playSound = g_GameContext.cfg.playSound - 1;
      }
      else if (iVar1 == 5) {
        FUN_004311e0(0xc,0);
    ...
    if ((((BUTTONS_PRESSED_CURFRAME & 0x80) != 0) &&
      ...
      if (iVar1 == 0) {
        ...
        FUN_00424d38();
        g_GameContext.cfg.soundMode = g_GameContext.cfg.soundMode + 1;
        if (2 < g_GameContext.cfg.soundMode) {
          g_GameContext.cfg.soundMode = 0;
        }
        FUN_00424b2f("bgm/th06_01.mid");
        FUN_00424b5d("bgm/th06_01.mid");
      }
        ...
        FUN_004311e0(0xc,0);
        g_GameContext.cfg.playSound = g_GameContext.cfg.playSound + 1;
        if (1 < g_GameContext.cfg.playSound) {
