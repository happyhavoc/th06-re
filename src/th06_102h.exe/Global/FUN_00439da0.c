...

{
  ...
  if (iVar1 == 0) {
    iVar1 = AnmManager::LoadAnim(g_AnmManager,0x18,"data/title02.anm",0x11b);
    if (iVar1 == 0) {
      iVar1 = AnmManager::LoadAnim(g_AnmManager,0x19,"data/title03.anm",0x11f);
      if (iVar1 == 0) {
        iVar1 = AnmManager::LoadAnim(g_AnmManager,0x1a,"data/title04.anm",0x122);
        if (iVar1 == 0) {
          iVar1 = AnmManager::LoadAnim(g_AnmManager,0x16,"data/title01s.anm",0x17a);
          if (iVar1 == 0) {
            iVar1 = AnmManager::LoadAnim(g_AnmManager,0x17,"data/title04s.anm",0x195);
            if (iVar1 == 0) {
              ...
              iVar1 = AnmManager::LogoStuff(g_AnmManager,0,"data/title/title00.jpg");
              if (iVar1 == 0) {
                uVar2 = 0;
              }
              else {
