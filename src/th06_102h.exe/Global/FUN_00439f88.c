...

{
  ...
  if (iVar1 == 0) {
    iVar1 = FUN_00431dc0((int)VERY_BIG_STRUCT,0x1b,"data/select01.anm",0x150);
    if (iVar1 == 0) {
      iVar1 = FUN_00431dc0((int)VERY_BIG_STRUCT,0x1c,"data/select02.anm",0x153);
      if (iVar1 == 0) {
        iVar1 = FUN_00431dc0((int)VERY_BIG_STRUCT,0x1d,"data/select03.anm",0x15a);
        if (iVar1 == 0) {
          iVar1 = FUN_00431dc0((int)VERY_BIG_STRUCT,0x1e,"data/select04.anm",0x15c);
          if (iVar1 == 0) {
            iVar1 = FUN_00431dc0((int)VERY_BIG_STRUCT,0x1f,"data/select05.anm",0x155);
            if (iVar1 == 0) {
              iVar1 = FUN_00431dc0((int)VERY_BIG_STRUCT,0x20,"data/slpl00a.anm",0x156);
              if (iVar1 == 0) {
                iVar1 = FUN_00431dc0((int)VERY_BIG_STRUCT,0x21,"data/slpl00b.anm",0x157);
                if (iVar1 == 0) {
                  iVar1 = FUN_00431dc0((int)VERY_BIG_STRUCT,0x22,"data/slpl01a.anm",0x158);
                  if (iVar1 == 0) {
                    iVar1 = FUN_00431dc0((int)VERY_BIG_STRUCT,0x23,"data/slpl01b.anm",0x159);
                    if (iVar1 == 0) {
