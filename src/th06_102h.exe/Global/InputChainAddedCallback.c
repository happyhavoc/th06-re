...

{
  ...
  for (iStack_14 = 0; iStack_14 < 0x10; iStack_14 = iStack_14 + 1) {
    param_1->field110_0x1bc[iStack_14] = 0;
  }
  piVar1 = param_1->field110_0x1bc;
  DAT_0069d900 = piVar1;
  ...
  if (piVar1 == (int *)0x0) {
    ...
    if (pvVar5 == (void *)0x0) {
      ...
      uStack_24 = FUN_00421df0();
    }
    uStack_8 = 0xffffffff;
    *(undefined4 *)&param_1->field_0x1b0 = uStack_24;
    DVar6 = timeGetTime();
    _DAT_0069d8fc = 0;
