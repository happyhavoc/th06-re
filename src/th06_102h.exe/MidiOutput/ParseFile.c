...

{
  ...
  size_t trackLength;
  int hdrLengthLE;
  undefined hdrLengthBE;
  undefined uStack_1f;
  undefined uStack_1e;
  undefined uStack_1d;
  undefined *currentCursor;
  int trackIdx;
  byte *file_data;
  undefined2 format;
  undefined4 hdrLenBe;
  ...
  if (file_data == (byte *)0x0) {
    ...
    hdrLengthBE = (undefined)hdrLenBe;
    hdrLengthLE = CONCAT13(hdrLengthBE,CONCAT12(uStack_1f,CONCAT11(uStack_1e,uStack_1d)));
                    /* Get a pointer to the end of the header chunk */
    currentCursor = (undefined *)((int)(file_data + 8) + hdrLengthLE);
    ...
    tmp_reg = CONCAT11((char)format,(char)((ushort)format >> 8));
    this->format = (uint)tmp_reg;
                    /* Read the number of tracks in this midi file.  */
    tmp_reg = CONCAT11((char)*(undefined2 *)(file_data + 0xc),
                       (char)((ushort)*(undefined2 *)(file_data + 0xc) >> 8));
    this->divisons = (uint)tmp_reg;
    ...
    tmp_reg = CONCAT11((char)*(undefined2 *)(file_data + 10),
                       (char)((ushort)*(undefined2 *)(file_data + 10) >> 8));
    this->num_tracks = (uint)tmp_reg;
    ...
    for (trackIdx = 0; trackIdx < this->num_tracks; trackIdx = trackIdx + 1) {
                    /* Read a track (MTrk) chunk.
                        ...
                        */
      hdrLenBe = *(undefined4 *)(currentCursor + 4);
      ...
      puVar4 = (undefined4 *)(currentCursor + 8);
