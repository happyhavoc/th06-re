...
int __thiscall MusicRoom::AddedCallback(MusicRoom *this,MusicRoom *param_1)
...
breakWhile:
            ...
            for (local_8 = 0; pAVar3 = g_AnmManager, local_8 < param_1->field10_0x1c;
              ...
              *(uint *)&param_1->field13_0x134[local_8].flags =
                   *(uint *)&param_1->field13_0x134[local_8].flags | 0x300;
            }
...
LAB_00425c09:
              ...
              if (local_5c == '\0') {
                *(uint *)&param_1->field4366_0x2334[local_8].flags =
                     *(uint *)&param_1->field4366_0x2334[local_8].flags & 0xfffffffd;
              }
              else {
                *(uint *)&param_1->field4366_0x2334[local_8].flags =
              ...
              *(uint *)&param_1->field4366_0x2334[local_8].flags =
                   *(uint *)&param_1->field4366_0x2334[local_8].flags | 0x300;
            }
            _free(firstChar);
            iVar5 = ZUN_SUCCESS;
          }
