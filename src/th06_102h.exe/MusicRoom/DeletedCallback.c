...

{
  ...
  AnmManager::ReleaseAnm((AnmManager *)g_AnmManager,0x29);
  AnmManager::ReleaseAnm((AnmManager *)g_AnmManager,0x2a);
  AnmManager::ReleaseAnm((AnmManager *)g_AnmManager,0x2b);
