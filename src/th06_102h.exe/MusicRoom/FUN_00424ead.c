...
void __thiscall MusicRoom::FUN_00424ead(MusicRoom *this)

{
  ...
  local_8 = *(undefined4 *)(this + 0x18);
  if (((g_CurFrameInput & 0x10) != 0) && ((g_CurFrameInput & 0x10) != (g_LastFrameInput & 0x10))) {
    *(int *)(this + 0x10) = *(int *)(this + 0x10) + -1;
    if (*(int *)(this + 0x10) < 0) {
      *(int *)(this + 0x10) = *(int *)(this + 0x1c) + -1;
      *(int *)(this + 0x18) = *(int *)(this + 0x1c) + -10;
    }
    else if (*(int *)(this + 0x10) < *(int *)(this + 0x18)) {
      *(undefined4 *)(this + 0x18) = *(undefined4 *)(this + 0x10);
    }
  }
  if (((g_CurFrameInput & 0x20) != 0) && ((g_CurFrameInput & 0x20) != (g_LastFrameInput & 0x20))) {
    *(int *)(this + 0x10) = *(int *)(this + 0x10) + 1;
    if (*(int *)(this + 0x10) < *(int *)(this + 0x1c)) {
      if (*(int *)(this + 0x18) <= *(int *)(this + 0x10) + -10) {
        *(int *)(this + 0x18) = *(int *)(this + 0x10) + -9;
      }
    }
    else {
  ...
  if (((g_CurFrameInput & 0x1001) != 0) &&
    ...
    *(undefined4 *)(this + 0x14) = *(undefined4 *)(this + 0x10);
    Supervisor::PlayAudio((char *)(*(int *)(this + 0x14) * 0x272 + *(int *)(this + 0x20)));
...
LAB_0042508a:
        puVar4 = (undefined4 *)
                 (*(int *)(this + 0x20) + *(int *)(this + 0x14) * 0x272 + 0x62 +
        ...
        local_5c = (char *)(*(int *)(this + 0x20) + *(int *)(this + 0x14) * 0x272 + 0x62 +
                           (local_c / 2) * 0x42);
        pcVar2 = local_5c + 1;
        do {
          cVar1 = *local_5c;
      ...
      if ((char)local_54[0] == '\0') {
        *(uint *)(this + local_c * 0x110 + 0x23b4) =
             *(uint *)(this + local_c * 0x110 + 0x23b4) & 0xfffffffd;
      }
      else {
      ...
      *(undefined4 *)(this + local_c * 0x110 + 0x23cc) = 0;
      *(uint *)(this + local_c * 0x110 + 0x23b4) =
           *(uint *)(this + local_c * 0x110 + 0x23b4) | 0x300;
    }
  }
