...

{
  ...
  AnmManager::FUN_00432ad0(g_AnmManager,&param_1->field12_0x24);
  for (local_8 = param_1->listingOffset; local_8 < param_1->listingOffset + 10;
    ...
    AnmManager::FUN_00432ad0(g_AnmManager,param_1->field13_0x134 + local_8);
  ...
  for (local_8 = 0; local_8 < 0x10; local_8 = local_8 + 1) {
    AnmManager::FUN_00432ad0(g_AnmManager,param_1->field4366_0x2334 + local_8);
  }
  g_AsciiManager.color = 0xffffffff;
  return 1;
}
