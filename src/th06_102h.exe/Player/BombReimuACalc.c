...

{
  ...
  if ((param_1->bombInfo).bombTimer.current < (param_1->bombInfo).bombDuration) {
    ...
    if ((0x3b < (param_1->bombInfo).bombTimer.current) &&
      ...
      if ((uVar5 == 0) &&
         (iVar4 = (param_1->bombInfo).bombTimer.current + -0x3c,
         iVar4 = (int)(iVar4 + (iVar4 >> 0x1f & 0xfU)) >> 4, iVar4 != 0)) {
        (param_1->bombInfo).reimuABombProjectilesState[iVar4] = 1;
        (param_1->bombInfo).unk3c[iVar4] = 4.0;
        pDVar1 = (param_1->bombInfo).unk5c + iVar4;
        ...
        (param_1->bombInfo).unkbc[iVar4].x = (float)dVar7 * (param_1->bombInfo).unk3c[iVar4];
        dVar7 = sin((double)angle);
        (param_1->bombInfo).unkbc[iVar4].y = (float)dVar7 * (param_1->bombInfo).unk3c[iVar4];
    ...
    for (local_10 = 0; local_10 < 8; local_10 = local_10 + 1) {
      if ((param_1->bombInfo).reimuABombProjectilesState[local_10] != 0) {
        if ((param_1->bombInfo).reimuABombProjectilesState[local_10] == 1) {
          if ((param_1->bombInfo).bombTimer.current != (param_1->bombInfo).bombTimer.previous) {
            ...
            local_24 = local_24 - (param_1->bombInfo).unk5c[local_10].x;
            local_20 = local_20 - (param_1->bombInfo).unk5c[local_10].y;
            local_18 = sqrt(SUB84((double)(local_24 * local_24 + local_20 * local_20),0));
            local_18 = local_18 / ((param_1->bombInfo).unk3c[local_10] / 8.0);
            if (local_18 < 1.0 != NAN(local_18)) {
              local_18 = 1.0;
            }
            angle = local_24 / local_18 + (param_1->bombInfo).unkbc[local_10].x;
            fVar3 = local_20 / local_18 + (param_1->bombInfo).unkbc[local_10].y;
            fVar6 = sqrt(SUB84((double)(angle * angle + fVar3 * fVar3),0));
            fVar8 = fVar6;
            if (10.0 < fVar6) {
              fVar8 = 10.0;
            }
            (param_1->bombInfo).unk3c[local_10] = fVar8;
            fVar8 = (param_1->bombInfo).unk3c[local_10];
            if (fVar8 < 1.0 != NAN(fVar8)) {
              (param_1->bombInfo).unk3c[local_10] = 1.0;
            }
            (param_1->bombInfo).unkbc[local_10].x =
                 (angle * (param_1->bombInfo).unk3c[local_10]) / fVar6;
            (param_1->bombInfo).unkbc[local_10].y =
                 (fVar3 * (param_1->bombInfo).unk3c[local_10]) / fVar6;
            param_1->unk_638[local_10].x = 48.0;
            param_1->unk_638[local_10].y = 48.0;
            pDVar1 = (param_1->bombInfo).unk5c + local_10;
            pDVar2 = param_1->unk_4b8 + local_10;
            pDVar2->x = pDVar1->x;
            pDVar2->y = pDVar1->y;
            pDVar2->z = pDVar1->z;
            param_1->unk_7b8[local_10] = 8;
            param_1->unk_8b8[local_10].position1.x = (param_1->bombInfo).unk5c[local_10].x;
            param_1->unk_8b8[local_10].position1.y = (param_1->bombInfo).unk5c[local_10].y;
               ...
               ((param_1->bombInfo).bombDuration + -0x1e <= (param_1->bombInfo).bombTimer.current))
            {
              ...
              (param_1->bombInfo).vms[local_10][2].pendingInterrupt = 1;
              (param_1->bombInfo).vms[local_10][3].pendingInterrupt = 1;
        ...
        else if ((((param_1->bombInfo).reimuABombProjectilesState[local_10] != 0) &&
                 ((param_1->bombInfo).bombTimer.current != (param_1->bombInfo).bombTimer.previous))
                && ((param_1->bombInfo).reimuABombProjectilesState[local_10] =
                         (param_1->bombInfo).reimuABombProjectilesState[local_10] + 1,
                   0x1d < (param_1->bombInfo).reimuABombProjectilesState[local_10])) {
          (param_1->bombInfo).reimuABombProjectilesState[local_10] = 0;
        }
        (param_1->bombInfo).unk5c[local_10].x =
             g_Supervisor.effectiveFramerateMultiplier * (param_1->bombInfo).unkbc[local_10].x +
             (param_1->bombInfo).unk5c[local_10].x;
        (param_1->bombInfo).unk5c[local_10].y =
             g_Supervisor.effectiveFramerateMultiplier * (param_1->bombInfo).unkbc[local_10].y +
             (param_1->bombInfo).unk5c[local_10].y;
        AnmManager::ExecuteScript(g_AnmManager,(param_1->bombInfo).vms[local_10]);
        AnmManager::ExecuteScript(g_AnmManager,(param_1->bombInfo).vms[local_10] + 1);
        AnmManager::ExecuteScript(g_AnmManager,(param_1->bombInfo).vms[local_10] + 2);
        AnmManager::ExecuteScript(g_AnmManager,(param_1->bombInfo).vms[local_10] + 3);
      }
    }
