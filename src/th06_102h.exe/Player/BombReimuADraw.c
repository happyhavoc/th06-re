  ...
  for (local_c = 0; local_c < 8; local_c = local_c + 1) {
    if (*(int *)((param_1->inner).field5_0x1c + local_c * 4) != 0) {
      ...
      *pfVar6 = g_GameManager.arcade_region_top_left_pos.y + *pfVar6;
      ...
      pPVar1 = (param_1->inner).field6_0x5c + local_c;
      fVar2 = pPVar1->field2_0x8;
      fVar3 = local_8[1].pos2.z;
      fVar4 = pPVar1->field1_0x4;
      fVar5 = local_8[1].pos2.y;
      local_8[1].pos.x = pPVar1->field0_0x0 + local_8[1].pos2.x;
      ...
      *pfVar6 = g_GameManager.arcade_region_top_left_pos.y + *pfVar6;
      ...
      pPVar1 = (param_1->inner).field6_0x5c + local_c;
      fVar2 = pPVar1->field2_0x8;
      fVar3 = local_8[2].pos2.z;
      fVar4 = pPVar1->field1_0x4;
      fVar5 = local_8[2].pos2.y;
      local_8[2].pos.x = pPVar1->field0_0x0 + local_8[2].pos2.x;
      ...
      *pfVar6 = g_GameManager.arcade_region_top_left_pos.y + *pfVar6;
      ...
      pPVar1 = (param_1->inner).field6_0x5c + local_c;
      fVar2 = pPVar1->field2_0x8;
      fVar3 = local_8[3].pos2.z;
      fVar4 = pPVar1->field1_0x4;
      fVar5 = local_8[3].pos2.y;
      local_8[3].pos.x = pPVar1->field0_0x0 + local_8[3].pos2.x;
