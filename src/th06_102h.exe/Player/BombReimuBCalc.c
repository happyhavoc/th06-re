  ...
  if ((param_1->inner).unk8.current < (param_1->inner).unk4) {
    if (((param_1->inner).unk8.current == (param_1->inner).unk8.previous) ||
      ...
      for (local_8 = 0; local_8 < 4; local_8 = local_8 + 1) {
        ...
        if ((param_1->inner).unk8.current != (param_1->inner).unk8.previous) {
          uVar8 = (param_1->inner).unk8.current & 0x80000001;
          if ((int)uVar8 < 0) {
            uVar8 = (uVar8 - 1 | 0xfffffffe) + 1;
          }
          if (uVar8 != 0) {
            param_1->unk_8b8[local_8].position1.x =
                 (param_1->inner).unk5c[local_8].x + (param_1->inner).vms[0][local_8].offset.x;
            param_1->unk_8b8[local_8].position1.y =
                 (param_1->inner).unk5c[local_8].y + (param_1->inner).vms[0][local_8].offset.y;
            param_1->unk_638[local_8].x = param_1->unk_8b8[local_8].size1.x;
            param_1->unk_638[local_8].y = param_1->unk_8b8[local_8].size1.y;
            pDVar1 = &(param_1->inner).vms[0][local_8].offset;
      ...
      (param_1->inner).unk4 = 0x8c;
      (param_1->blinkingPlayerTimer).current = 200;
      ...
      (param_1->inner).unk5c[0].x = (param_1->positionCenter).x;
      (param_1->inner).unk5c[0].y = 224.0;
      (param_1->inner).unk5c[0].z = 0.42;
      (param_1->inner).unk5c[1].x = 192.0;
      (param_1->inner).unk5c[1].y = (param_1->positionCenter).y;
      (param_1->inner).unk5c[1].z = 0.415;
      (param_1->inner).unk5c[2].x = (param_1->positionCenter).x;
      (param_1->inner).unk5c[2].y = 224.0;
      (param_1->inner).unk5c[2].z = 0.41;
      (param_1->inner).unk5c[3].x = 192.0;
      (param_1->inner).unk5c[3].y = (param_1->positionCenter).y;
      (param_1->inner).unk5c[3].z = 0.405;
