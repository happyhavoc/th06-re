...
ZunResult th06::ReplayManager::AddedCallback(ReplayManager *param_1)

{
  ...
  if (param_1->data == (ReplayData *)0x0) {
    ...
    *(undefined4 *)param_1->data->name = 0x4e204f4e;
    for (local_c = 0; local_c < 7; local_c = local_c + 1) {
      param_1->data->stage_replay_data[local_c] = (StageReplayData *)0x0;
    }
  }
  else {
    pSVar2 = param_1->data->stage_replay_data[g_GameManager.current_stage + -2];
  ...
  param_1->data->stage_replay_data[g_GameManager.current_stage + -1] = pSVar2;
  pSVar2 = param_1->data->stage_replay_data[g_GameManager.current_stage + -1];
  ...
  pSVar2->point_items_collected = g_GameManager.point_items_collected;
