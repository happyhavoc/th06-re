  ...
  if (data == (byte *)0x0) {
    ...
    if (HVar2 == 0) {
      iVar3 = FUN_0043fec2((int)local_8,0,0,data,g_FileSize,(int *)0x0,1,0,
                           this->field19621_0x20e34 + param_2);
      if (((iVar3 == 0) &&
          (((HVar2 = (*(g_GameContext.d3d_device)->lpVtbl->CreateRenderTarget)
                               (g_GameContext.d3d_device,
                                this->field19621_0x20e34[param_2].field0_0x0,
                                this->field19621_0x20e34[param_2].field1_0x4,
                                g_GameContext.present_parameters.BackBufferFormat,
                                D3DMULTISAMPLE_NONE,1,
                                (IDirect3DSurface8 **)(this->field19492_0x20d34 + param_2)),
            HVar2 == 0 ||
            (HVar2 = (*(g_GameContext.d3d_device)->lpVtbl->CreateImageSurface)
                               (g_GameContext.d3d_device,
                                this->field19621_0x20e34[param_2].field0_0x0,
            ...
            HVar2 == 0)) &&
           (HVar2 = (*(g_GameContext.d3d_device)->lpVtbl->CreateImageSurface)
                              (g_GameContext.d3d_device,this->field19621_0x20e34[param_2].field0_0x0
                               ,this->field19621_0x20e34[param_2].field1_0x4,
                               g_GameContext.present_parameters.BackBufferFormat,
                               (IDirect3DSurface8 **)(this->field19492_0x20d34 + param_2 + 0x20)),
           HVar2 == 0)))) &&
         ((iVar3 = FUN_0043ff78(this->field19492_0x20d34[param_2],0,0,local_8,0,0,1,0), iVar3 == 0
          && (iVar3 = FUN_0043ff78(this->field19492_0x20d34[param_2 + 0x20],0,0,local_8,0,0,1,0),
             iVar3 == 0)))) {
